...
return {
	...
	{
		"lervag/vimtex",
		lazy = false, -- load on startup - we don't want ot lazy load VimtTeX
		-- tag = "v2.15", -- uncomment to pin to a specific release
		init = function()
			-- VimTeX configuration goes here:
			-- PLEASE don't jsut copy it in without reading the comments! :)
			-- This is necessary for VimTeX to lead properly. The "indent" is optional.
			...
			-- mehr infos mit diesem command ':help vimtex' und dann nach quickfix suchen
